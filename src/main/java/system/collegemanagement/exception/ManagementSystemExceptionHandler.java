package system.collegemanagement.exception;
...
import system.collegemanagement.beans.ExceptionResponse;
...
public class ManagementSystemExceptionHandler {

    private static final Logger LOGGER = LogManager.getLogger(ManagementSystemExceptionHandler.class);

    private static final String SINGLE_QUOTE = "'";
    private static final String INTERNAL_ERROR = "Internal Error. Please contact support.";

    @ExceptionHandler
    public ResponseEntity<Object> handleMainServiceException(final ManagementSystemServerException exception){
